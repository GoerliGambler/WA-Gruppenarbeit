...
# Die W�lbungswert von ~3 zeigt eine leptokurtische Verteilung an.
...
# und "programmieren". Bei "interesseMathe" sieht liegen der gro�teil der Daten
# in der Kategorie "Mittel". Die Kategorien "Hoch" und "Niedrig" sind kaum
# vertreten. Bei "Programmieren" sind die Kategorie gleichm�ssiger besetzt,
# auch wenn "Mittel" am h�ufigsten auftritt.
